...
layer_lrs = {0: 0.1, 1: 0.01, 2: 0.001}

model = nn.Model(module = nn.module.MLP([784, 600, 10], 'Sigmoid', [1e-4, 1e-4]),
                optimizer = nn.optimizer.SGD_layerWise(init_lr=0.6, layer_lrs=layer_lrs),
                scheduler = nn.lr_scheduler.MultiStepLR_layerWise(milestones=[800, 2400, 4000], gamma=0.5),
                loss_fn = 'CrossEntropyLoss'
                )

save_folder = "../saved_models/idx05"
