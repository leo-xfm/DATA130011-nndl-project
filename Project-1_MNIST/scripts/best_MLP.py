...
model = nn.Model(module = nn.module.MLP([784, 512, 128, 10], 'ReLU', lambda_list=[5e-4]*3),
                optimizer = nn.optimizer.MomentGD(init_lr=0.08, mu=0.99),
                scheduler = nn.lr_scheduler.MultiStepLR(milestones=[50, 100], gamma=0.5),
                loss_fn = 'CrossEntropyLoss'
                )

save_folder = "../saved_models/best_MLP1"
